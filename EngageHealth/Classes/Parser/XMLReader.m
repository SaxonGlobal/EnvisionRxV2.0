...
{
    XMLReader *reader = [[XMLReader alloc] initWithError:error];
    NSDictionary *rootDictionary = [reader objectWithParser:parser withOptions:0];
    return rootDictionary;
}
...
- (NSDictionary *)objectWithParser:(NSXMLParser *)parser withOptions:(XMLReaderOptions)options {
